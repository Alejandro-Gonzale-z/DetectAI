...
const AIContentArray = [
  ...
  {contentType: 'TXT', contentSource: textSource2, context: "This may or may not be an excerpt from a recently released ESPN article.", reasons: ['The correct answer is human created.', 'If anyone here follows basketball, the details written in this excerpt are true and very recent as the NBA season just started.', "The informality of the content, such as 'its clear things are working out', is another indicator that this is human written.",], correctAnswer: 'AI'},
